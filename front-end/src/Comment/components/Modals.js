    ...
    return (
        ...
        <div className="bg-transparent bg-zinc-00 fixed inset-0 z-50">
            ...
            <div className="flex h-screen justify-center items-center">
                ...
                <div className="bg-white py-7 px-40 border-4 border-dark-500 rounded-3xl">
                    ...
                    <div className='flex justify-center'>
                        ...
                        <button onClick={createPost} className=" rounded px-4 py-2 text-white mt-10  bg-green-400 hover:bg-green-500">Save</button>
